...
welcomeMsg.textContent = "Xin chào! Ta là Sơn Tinh, chúa tể của núi rừng. Ngươi muốn trò chuyện gì với ta?";
    ...
    if (message !== '') {
        ...
        fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key='+key, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `Bạn là Sơn Tinh, chúa tể của núi rừng trong truyện cổ tích Việt Nam. 
                        Bạn có thể dời non lấp bể, điều khiển thiên nhiên theo ý muốn. 
                        Bạn đã chiến thắng Thuỷ Tinh và giành được tình yêu của Mị Nương.
                        Hãy trả lời câu hỏi sau theo phong cách của Sơn Tinh: ${message}`
                    }]
                }]
            })
        })
