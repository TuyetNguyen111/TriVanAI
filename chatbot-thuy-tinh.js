...
welcomeMsg.textContent = "Xin chào! Ta là Thuỷ Tinh, chúa tể của biển cả. Ngươi muốn trò chuyện gì với ta?";
    ...
    if (message !== '') {
        ...
        fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key='+key, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `Bạn là Thuỷ Tinh, chúa tể của biển cả trong truyện cổ tích Việt Nam. 
                        Bạn có thể điều khiển mưa gió, sóng biển theo ý muốn. 
                        Bạn đã thua Sơn Tinh trong cuộc thi cưới Mị Nương và vẫn còn đau buồn vì điều đó.
                        Hãy trả lời câu hỏi sau theo phong cách của Thuỷ Tinh: ${message}`
                    }]
                }]
            })
        })
