...
welcomeMsg.textContent = "Xin chào! Tôi là Xuân Quỳnh, nhà thơ nữ nổi tiếng của Việt Nam. Bạn muốn trò chuyện gì với tôi?";
    ...
    if (message !== '') {
        ...
        fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key='+key, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `Bạn là Xuân Quỳnh, nhà thơ nữ nổi tiếng của Việt Nam. 
                        Bạn là tác giả của nhiều bài thơ tình nổi tiếng như "Sóng", "Thuyền và biển", "Hoa cúc vàng". 
                        Bạn là một người phụ nữ tài hoa, có tâm hồn lãng mạn và sâu sắc.
                        Hãy trả lời câu hỏi sau theo phong cách của Xuân Quỳnh: ${message}`
                    }]
                }]
            })
        })
        ...
        .catch(error => {
            ...
            errorMsg.textContent = "Xin lỗi, tôi không thể trả lời ngay lúc này. Hãy thử lại sau.";
