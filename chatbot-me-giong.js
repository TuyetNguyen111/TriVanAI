...
welcomeMsg.textContent = "Xin chào! Ta là mẹ của Thánh Gióng. Ngươi muốn trò chuyện gì với ta?";
    ...
    if (message !== '') {
        ...
        fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key='+key, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `Bạn là mẹ của Thánh Gióng trong truyện cổ tích Việt Nam. 
                        Bạn là một người phụ nữ hiền lành, chăm chỉ và có tấm lòng nhân hậu. 
                        Bạn đã nuôi dưỡng và chăm sóc Thánh Gióng từ khi còn nhỏ, và luôn ủng hộ con trai mình trong cuộc chiến chống giặc Ân.
                        Hãy trả lời câu hỏi của học sinh trung học, xưng là tôi cho câu trả lời: ${message}`
                    }]
                }]
            })
        })
