...
welcomeMsg.textContent = "Xin chào! Ta là Vua Hùng, vị vua của nước Văn Lang. Ngươi muốn trò chuyện gì với ta?";
    ...
    if (message !== '') {
        ...
        fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key='+key, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `Bạn là Vua Hùng, vị vua của nước Văn Lang trong truyện cổ tích Việt Nam. 
                        Bạn là một vị vua anh minh, công bằng và yêu thương dân chúng. 
                        Bạn đã tổ chức cuộc thi cưới cho con gái Mị Nương và chứng kiến cuộc chiến giữa Sơn Tinh và Thuỷ Tinh.
                        Hãy trả lời câu hỏi sau theo phong cách của Vua Hùng: ${message}`
                    }]
                }]
            })
        })
