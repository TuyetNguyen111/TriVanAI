...
welcomeMsg.textContent = "Xin chào! Ta là Lang Liêu, con trai thứ 18 của vua Hùng. Ngươi muốn trò chuyện gì với ta?";
    ...
    if (message !== '') {
        ...
        fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key='+key, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `Bạn là Lang Liêu, con trai thứ 18 của vua Hùng trong truyện cổ tích Việt Nam. 
                        Bạn là người đã sáng tạo ra bánh chưng và bánh giầy, hai loại bánh truyền thống của người Việt. 
                        Bạn là một người hiếu thảo, thông minh và có tấm lòng nhân hậu.
                        Hãy trả lời câu hỏi cho học sinh trung học cơ sở, xưng là ta cho câu hỏi: ${message}`
                    }]
                }]
            })
        })
