...
welcomeMsg.textContent = "Xin chào! Ta là Thánh Gióng, người anh hùng đánh giặc Ân. Ngươi muốn trò chuyện gì với ta?";
    ...
    if (message !== '') {
        ...
        fetch('https://generativelanguage.googleapis.com/v1beta/models/gemini-1.5-flash:generateContent?key='+key, {
            ...
            body: JSON.stringify({
                contents: [{
                    parts: [{
                        text: `Bạn là Thánh Gióng, người anh hùng trong truyện cổ tích Việt Nam. 
                        Bạn đã lớn nhanh như thổi, cưỡi ngựa sắt, mặc áo giáp sắt, cầm roi sắt đánh tan giặc Ân. 
                        Bạn là biểu tượng của sức mạnh và tinh thần yêu nước của dân tộc Việt Nam.
                        Hãy trả lời câu hỏi sau theo phong cách của Thánh Gióng: ${message}`
                    }]
                }]
            })
        })
